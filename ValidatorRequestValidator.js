...
class ValidatorRequestValidator {
...
primary_key_column: Joi.integer().min(-2147483648).max(2147483647).optional(),
unique_column: Joi.string().max(50).optional(),
            });
...
module.exports = ValidatorRequestValidator;