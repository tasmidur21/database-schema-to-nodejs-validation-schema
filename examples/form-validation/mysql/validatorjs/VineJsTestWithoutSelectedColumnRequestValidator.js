...
export default class VineJsTestWithoutSelectedColumnRequestValidator {
  ...
  public schema = schema.create({
   ...
   bigint_column: vine.integer().enum([-9223372036854775808]).maxLength(9223372036854775807).optional(),
   ...
   timestamp_column: vine.date().any().any().optional(),
   boolean_column: vine.boolean().optional(),
   enum_column: vine.string().enum([1,2,3]).optional(),
